...
public static class OverlayTextFormatter
{
    public static string FormatMain(OverlayViewModel vm, LiveGameState live)
    {
        ...
        {
            sb.Append("<color=#AAFFAA><b>RECOMMENDED: option ").Append(vm.RecommendedOption);
        ...
        if (vm.EnginePick > 0)
            sb.AppendLine("Game picks: option " + vm.EnginePick + " (" + vm.EngineStat + ")");
